...
CM_EID_Desc_zh_cn.Collectibles = {
	...
	[modCollectibleType.COLLECTIBLE_BLUE_GRIMOIRE] = {
		...
		bookOfVirtuesWisps = "火炎术：爆炸泪弹；冰冻术：减速泪弹；闪电术：激光泪弹#{{Player"..modPlayerType.PLAYER_ARLENADJA.."}}只对以下法术有效：治疗术：20%几率杀怪掉落红心；二阶强化术：灰色普通魂火；繁花乱象：7.5%几率发射标记泪弹；荆棘障壁：护盾魂火",
		bookOfBelialBuffs = "x130%魔法伤害",
	},
	[modCollectibleType.COLLECTIBLE_PUYO_HAT] = {
		Name = "噗哟帽",
		Description = "噗哟不再发射子弹，且接触噗哟时不再受到伤害#噗哟生成几率+15%",
	},
	...
	[modCollectibleType.COLLECTIBLE_HEART_SHAPED_COOKIE] = {
		Name = "心形饼干",
		Description = "接触敌人时，角色不再受到伤害#{{Player"..PlayerType.PLAYER_MAGDALENE_B.."}}堕化抹大拉：50%几率#!!! 对堕化以扫无效",
	},
...
CM_EID_Desc_zh_cn.Trinkets = {
	[modTrinketType.TRINKET_ANOTHER_CARTRIDE] = {
		Name = "另一张游戏卡带",
		Description = "在每层的随机一个房间内的随机位置生成一个外星联络点#在外星联络点上引爆炸弹可重置并重新开始所在楼层",
	},
}
